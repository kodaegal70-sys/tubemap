export const CATEGORY_MAP: Record<string, string[]> = {
    '한식': ['한식', '냉면', '불고기', '비빔밥', '찜', '탕', '찌개', '고기', '곱창', '막창', '해장국', '국밥', '백반', '정식', '족발', '보쌈', '삼겹살', '고깃집', '국수', '칼국수', '해물', '아구찜', '전', '부침개', '쌈밥'],
    '중식': ['중식', '중국집', '짜장면', '짬뽕', '마라탕', '양꼬치', '딤섬', '양장피', '탕수육'],
    '일식': ['일식', '초밥', '스시', '돈가스', '우동', '라멘', '이자카야', '회', '횟집', '소바', '텐동', '가츠동', '참치'],
    '양식': ['양식', '이탈리안', '프렌치', '스테이크', '파스타', '피자', '햄버거', '레스토랑', '브런치', '와인바', '펍', '호프'],
    '분식': ['분식', '떡볶이', '김밥', '라면', '튀김', '순대'],
    '기타': ['카페', '디저트', '베이커리', '술집', '포차', '치킨', '패스트푸드', '동남아', '베트남', '태국', '인도', '멕시칸', '커피', '샌드위치', '전통찻집', '베이글', '도넛']
};
